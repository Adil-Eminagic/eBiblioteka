        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MortalDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Genres",
                columns: new[] { "Id", "Abbreviation", "CreatedAt", "ModifiedAt", "Name" },
                values: new object[,]
                {
                    { 1, "ROM", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Roman" },
                    { 2, "DRM", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Drama" },
                    { 3, "BJK", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Bajka" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "Biography", "BirthDate", "CountryId", "CreatedAt", "FirstName", "Gender", "LastName", "ModifiedAt", "MortalDate" },
                values: new object[,]
                {
                    { 1, null, new DateTime(1910, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Meša", 0, "Selimović", null, new DateTime(1982, 7, 11, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, null, new DateTime(1892, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Ivo", 0, "Andrić", null, new DateTime(1975, 3, 13, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, null, new DateTime(1564, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 7, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Wiliam", 0, "Shakspeare", null, new DateTime(1616, 4, 23, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, null, new DateTime(1805, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 8, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Hans Christian", 0, "Andersen", null, new DateTime(1875, 8, 4, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Biography", "BirthDate", "CountryId", "CreatedAt", "Email", "FirstName", "Gender", "LastName", "LastSignInAt", "ModifiedAt", "PasswordHash", "PasswordSalt", "PhoneNumber", "ProfilePhotoId", "Role" },
                values: new object[] { 1, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "site.admin@ridewithme.com", "Site", 0, "Admin", null, null, "b4I5yA4Mp+0Pg1C3EsKU17sS13eDExGtBjjI07Vh/JM=", "1wQEjdSFeZttx6dlvEDjOg==", "38761123456", null, 0 });
